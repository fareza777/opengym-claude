...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Tempa locally on this device.": 'यह ब्राउज़र पासकी सपोर्ट नहीं करता — फिर भी आप इस डिवाइस पर Tempa लोकली इस्तेमाल कर सकते हैं।',
  ...
  'to install Tempa as a full-screen app.': 'से Tempa को फुल-स्क्रीन ऐप के रूप में इंस्टॉल करें।',
  ...
  'Rest-timer alerts, even if Tempa is closed.': 'आराम टाइमर अलर्ट, Tempa बंद होने पर भी।',
  ...
  'A small file a friend imports into their own Tempa — routines only, none of your workouts or weigh-ins.': 'एक छोटी फ़ाइल जिसे कोई दोस्त अपने Tempa में आयात कर सके — सिर्फ़ रूटीन, आपके वर्कआउट या वज़न नहीं।',
  ...
  'Reload Tempa': 'Tempa फिर से लोड करें',
