...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Tempa locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst Tempa trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'to install Tempa as a full-screen app.': 'um Tempa als Vollbild-App zu installieren.',
  ...
  'Rest-timer alerts, even if Tempa is closed.': 'Pausen-Timer-Alarm, auch wenn Tempa geschlossen ist.',
  ...
  'A small file a friend imports into their own Tempa — routines only, none of your workouts or weigh-ins.': 'Eine kleine Datei, die ein Freund in sein eigenes Tempa importiert — nur Routinen, keine Workouts oder Wiegungen.',
