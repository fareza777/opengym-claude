...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Tempa locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de Tempa’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install Tempa as a full-screen app.': 'ile Tempa’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if Tempa is closed.': 'Tempa kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own Tempa — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi Tempa\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
