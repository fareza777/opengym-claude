...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Tempa locally on this device.": 'Этот браузер не поддерживает ключи доступа — но Tempa можно использовать локально на этом устройстве.',
  ...
  'to install Tempa as a full-screen app.': 'чтобы установить Tempa как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if Tempa is closed.': 'Оповещения таймера отдыха, даже если Tempa закрыт.',
  ...
  'A small file a friend imports into their own Tempa — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой Tempa — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload Tempa': 'Перезагрузить Tempa',
