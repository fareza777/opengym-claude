...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Tempa locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar Tempa localmente en este dispositivo.',
  ...
  'to install Tempa as a full-screen app.': 'para instalar Tempa como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if Tempa is closed.': 'Avisos del temporizador de descanso, incluso con Tempa cerrado.',
  ...
  'A small file a friend imports into their own Tempa — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio Tempa: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
